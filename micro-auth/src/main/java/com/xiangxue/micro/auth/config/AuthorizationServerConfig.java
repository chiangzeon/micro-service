package com.xiangxue.micro.auth.config;

import com.xiangxue.micro.auth.entities.User;
import com.xiangxue.micro.auth.service.ClientDetailsService;
import com.xiangxue.micro.auth.service.UserServiceDetail;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) {
        ClientDetailsService jdbcClientDetailsService = new ClientDetailsService(dataSource);
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(
                new ClassPathResource("chiang-jwt.jks"), "chiang".toCharArray());
        KeyPair keyPair = factory.getKeyPair(
                "chiang-jwt", "chiang".toCharArray());
        return keyPair;
    }*/
